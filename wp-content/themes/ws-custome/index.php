            ...
            <div class="container">
                <div class="row g-5 align-items-center">
                    <div class="col-lg-6 wow zoomIn" data-wow-delay="0.1s">
                        <img class="img-fluid" src="<?php echo get_template_directory_uri(); ?>/img/about.png">
                    </div>
            ...
            <div class="container px-lg-5">
                <div class="row align-items-center" style="height: 250px;">
                    ...
                    <div class="col-md-6 text-center mb-n5 d-none d-md-block">
                        <img class="img-fluid mt-5" style="max-height: 250px;" src="<?php echo get_template_directory_uri(); ?>/img/newsletter.png">
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="container-xxl bg-primary my-6 py-5 wow fadeInUp" data-wow-delay="0.1s">
            <div class="container">
                <div class="owl-carousel client-carousel">
                    <a href="#"><img class="img-fluid" src="<?php echo get_template_directory_uri(); ?>/img/logo-1.png" alt=""></a>
                    <a href="#"><img class="img-fluid" src="<?php echo get_template_directory_uri(); ?>/img/logo-2.png" alt=""></a>
                    <a href="#"><img class="img-fluid" src="<?php echo get_template_directory_uri(); ?>/img/logo-3.png" alt=""></a>
                    <a href="#"><img class="img-fluid" src="<?php echo get_template_directory_uri(); ?>/img/logo-4.png" alt=""></a>
                    <a href="#"><img class="img-fluid" src="<?php echo get_template_directory_uri(); ?>/img/logo-5.png" alt=""></a>
                    <a href="#"><img class="img-fluid" src="<?php echo get_template_directory_uri(); ?>/img/logo-6.png" alt=""></a>
                    <a href="#"><img class="img-fluid" src="<?php echo get_template_directory_uri(); ?>/img/logo-7.png" alt=""></a>
                    <a href="#"><img class="img-fluid" src="<?php echo get_template_directory_uri(); ?>/img/logo-8.png" alt=""></a>
                </div>
            </div>
        </div>
        <!-- Client End -->
                ...
                <div class="owl-carousel testimonial-carousel wow fadeInUp" data-wow-delay="0.1s">
                    <div class="testimonial-item rounded p-4">
                        ...
                        <div class="d-flex align-items-center">
                            <img class="img-fluid flex-shrink-0 rounded-circle" src="<?php echo get_template_directory_uri(); ?>/img/testimonial-1.jpg">
                            <div class="ps-3">
                    ...
                    <div class="testimonial-item rounded p-4">
                        ...
                        <p>Dolor et eos labore, stet justo sed est sed. Diam sed sed dolor stet amet eirmod eos labore diam</p>
                        <div class="d-flex align-items-center">
                            <img class="img-fluid flex-shrink-0 rounded-circle" src="<?php echo get_template_directory_uri(); ?>/img/testimonial-2.jpg">
                            <div class="ps-3">
                                <h6 class="mb-1">Client Name</h6>
                                <small>Profession</small>
                            </div>
                    ...
                    <div class="testimonial-item rounded p-4">
                        ...
                        <p>Dolor et eos labore, stet justo sed est sed. Diam sed sed dolor stet amet eirmod eos labore diam</p>
                        <div class="d-flex align-items-center">
                            <img class="img-fluid flex-shrink-0 rounded-circle" src="<?php echo get_template_directory_uri(); ?>/img/testimonial-3.jpg">
                            <div class="ps-3">
                                <h6 class="mb-1">Client Name</h6>
                                <small>Profession</small>
                            </div>
                    ...
                    <div class="testimonial-item rounded p-4">
                        ...
                        <p>Dolor et eos labore, stet justo sed est sed. Diam sed sed dolor stet amet eirmod eos labore diam</p>
                        <div class="d-flex align-items-center">
                            <img class="img-fluid flex-shrink-0 rounded-circle" src="<?php echo get_template_directory_uri(); ?>/img/testimonial-4.jpg">
                            <div class="ps-3">
                                <h6 class="mb-1">Client Name</h6>
                                <small>Profession</small>
                            </div>
                ...
                <div class="row g-4">
                    <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                        <div class="team-item">
                            ...
                            <img class="img-fluid rounded-circle w-100 mb-4" src="<?php echo get_template_directory_uri(); ?>/img/team-1.jpg" alt="">
                    ...
                    <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.3s">
                        <div class="team-item">
                            <h5>Full Name</h5>
                            <p class="mb-4">Designation</p>
                            <img class="img-fluid rounded-circle w-100 mb-4" src="<?php echo get_template_directory_uri(); ?>/img/team-2.jpg" alt="">
                            <div class="d-flex justify-content-center">
                                <a class="btn btn-square text-primary bg-white m-1" href=""><i class="fab fa-facebook-f"></i></a>
                                <a class="btn btn-square text-primary bg-white m-1" href=""><i class="fab fa-twitter"></i></a>
                                <a class="btn btn-square text-primary bg-white m-1" href=""><i class="fab fa-linkedin-in"></i></a>
                    ...
                    <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.5s">
                        <div class="team-item">
                            <h5>Full Name</h5>
                            <p class="mb-4">Designation</p>
                            <img class="img-fluid rounded-circle w-100 mb-4" src="<?php echo get_template_directory_uri(); ?>/img/team-3.jpg" alt="">
                            <div class="d-flex justify-content-center">
                                <a class="btn btn-square text-primary bg-white m-1" href=""><i class="fab fa-facebook-f"></i></a>
                                <a class="btn btn-square text-primary bg-white m-1" href=""><i class="fab fa-twitter"></i></a>
                                <a class="btn btn-square text-primary bg-white m-1" href=""><i class="fab fa-linkedin-in"></i></a>
                    ...
                    <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.7s">
                        <div class="team-item">
                            <h5>Full Name</h5>
                            <p class="mb-4">Designation</p>
                            <img class="img-fluid rounded-circle w-100 mb-4" src="<?php echo get_template_directory_uri(); ?>/img/team-4.jpg" alt="">
                            <div class="d-flex justify-content-center">
                                <a class="btn btn-square text-primary bg-white m-1" href=""><i class="fab fa-facebook-f"></i></a>
                                <a class="btn btn-square text-primary bg-white m-1" href=""><i class="fab fa-twitter"></i></a>
                                <a class="btn btn-square text-primary bg-white m-1" href=""><i class="fab fa-linkedin-in"></i></a>
